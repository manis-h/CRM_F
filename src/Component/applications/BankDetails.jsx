...
const BankDetails = () => {
    ...
    const bankRes = useGetBankDetailsQuery(applicationProfile?.applicant,{skip:applicationProfile?.applicant === null})
    ...
    const onSubmit = (data) => {
        ...
        addBank({id:applicationProfile.applicant,data});  
    ...
    useEffect(() => {
        if(bankRes.isSuccess){
            ...
            setBankDetails(bankRes?.data[1])
            // reset(bankRes.data[1])

        }

    },[bankRes.isSuccess,bankRes.data])
    console.log('bank detaillllll',bankDetails)
                        ...
                        <Box display="flex" flexDirection="column" gap={2}>
                            <Box display="flex" flexDirection={{ xs: 'column', sm: 'row' }} gap={2}>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <TextField label="Bank Name" defaultValue={bankDetails?.bankName ?? " "} fullWidth {...field} />
                                    )}
                                />
                                <Controller
                                    name="branchName"
